...
const CONSTLAT = '-8.0524478';
const CONSTLNG = '-34.9519173';
class Map extends Component {
	constructor(props) {
		...
		this.state = {
			...
			region: {
				latitude: parseFloat(CONSTLAT),
				longitude: parseFloat(CONSTLNG),
	...
	_renderMap = () => {
		...
		const placeWeather = weather ? weather : 'Não informado.';
		return (
